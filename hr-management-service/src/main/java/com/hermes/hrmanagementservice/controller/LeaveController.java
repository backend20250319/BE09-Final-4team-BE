...
import com.hermes.hrmanagementservice.dto.leave.CreateLeaveRequestDto;
import com.hermes.hrmanagementservice.dto.leave.LeaveRequestResponseDto;
import com.hermes.hrmanagementservice.service.LeaveService;
...
public class LeaveController {
    ...
    public ApiResult<LeaveRequestResponseDto> createLeaveRequest(
        ...
        try {
            ...
            return ApiResult.failure("휴가 신청 생성 중 오류가 발생했습니다.");
        }
    }
    ...
    public ApiResult<LeaveRequestResponseDto> modifyLeaveRequest(
        ...
        try {
            ...
            return ApiResult.failure("휴가 신청 수정 중 오류가 발생했습니다.");
        }
    }
    ...
    public ApiResult<LeaveRequestResponseDto> getLeaveRequest(
        ...
        try {
            ...
            return ApiResult.failure("휴가 신청 조회 중 오류가 발생했습니다.");
        }
    }
} 