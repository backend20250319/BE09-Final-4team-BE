...
public class ApprovalDocumentController {
    ...
    @ApiResponses(value = {
            @SwaggerApiResponse(responseCode = "200", description = "문서 목록 조회 성공"),
    ...
    @ApiResponses(value = {
            @SwaggerApiResponse(responseCode = "200", description = "승인 대기 문서 목록 조회 성공"),
            @SwaggerApiResponse(responseCode = "401", description = "인증이 필요합니다"),
            @SwaggerApiResponse(responseCode = "500", description = "서버 내부 오류")
    })
    @GetMapping("/pending")
    ...
    @ApiResponses(value = {
            @SwaggerApiResponse(responseCode = "200", description = "문서 조회 성공"),
            @SwaggerApiResponse(responseCode = "401", description = "인증이 필요합니다"),
    ...
    @ApiResponses(value = {
            @SwaggerApiResponse(responseCode = "200", description = "문서 작성 성공"),
    ...
    @ApiResponses(value = {
            @SwaggerApiResponse(responseCode = "200", description = "문서 수정 성공"),
            @SwaggerApiResponse(responseCode = "400", description = "잘못된 요청 데이터"),
            @SwaggerApiResponse(responseCode = "401", description = "인증이 필요합니다"),
            @SwaggerApiResponse(responseCode = "403", description = "문서 수정 권한이 없습니다"),
            @SwaggerApiResponse(responseCode = "404", description = "문서를 찾을 수 없습니다"),
            @SwaggerApiResponse(responseCode = "500", description = "서버 내부 오류")
    })
    @PutMapping("/{id}")
    ...
    @ApiResponses(value = {
            @SwaggerApiResponse(responseCode = "200", description = "문서 제출 성공"),
            @SwaggerApiResponse(responseCode = "401", description = "인증이 필요합니다"),
            @SwaggerApiResponse(responseCode = "403", description = "문서 제출 권한이 없습니다"),
            @SwaggerApiResponse(responseCode = "404", description = "문서를 찾을 수 없습니다"),
            @SwaggerApiResponse(responseCode = "409", description = "이미 제출된 문서입니다"),
            @SwaggerApiResponse(responseCode = "500", description = "서버 내부 오류")
    })
    ...
    @ApiResponses(value = {
            @SwaggerApiResponse(responseCode = "200", description = "문서 승인 성공"),
            @SwaggerApiResponse(responseCode = "400", description = "잘못된 요청 데이터"),
            @SwaggerApiResponse(responseCode = "401", description = "인증이 필요합니다"),
            @SwaggerApiResponse(responseCode = "403", description = "문서 승인 권한이 없습니다"),
            @SwaggerApiResponse(responseCode = "404", description = "문서를 찾을 수 없습니다"),
            @SwaggerApiResponse(responseCode = "409", description = "승인할 수 없는 문서 상태입니다"),
            @SwaggerApiResponse(responseCode = "500", description = "서버 내부 오류")
    })
    ...
    @ApiResponses(value = {
            @SwaggerApiResponse(responseCode = "200", description = "문서 반려 성공"),
            @SwaggerApiResponse(responseCode = "400", description = "잘못된 요청 데이터"),
            @SwaggerApiResponse(responseCode = "401", description = "인증이 필요합니다"),
            @SwaggerApiResponse(responseCode = "403", description = "문서 반려 권한이 없습니다"),
            @SwaggerApiResponse(responseCode = "404", description = "문서를 찾을 수 없습니다"),
            @SwaggerApiResponse(responseCode = "409", description = "반려할 수 없는 문서 상태입니다"),
            @SwaggerApiResponse(responseCode = "500", description = "서버 내부 오류")
    })
