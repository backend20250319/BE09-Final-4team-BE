...
public class CompanyInfoController {
     ...
     */
    @PostMapping
    public ResponseEntity<ApiResponse<CompanyInfoDto>> createCompanyInfo(@RequestBody CompanyInfoDto companyInfoDto) {
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.CREATED)
                    .body(ApiResponse.success("회사 정보가 성공적으로 생성되었습니다.", createdCompanyInfo));
            ...
            return ResponseEntity.internalServerError()
                    .body(ApiResponse.failure("회사 정보 생성 중 오류가 발생했습니다."));
        }
    }
     ...
     */
    @GetMapping
    public ResponseEntity<ApiResponse<List<CompanyInfoDto>>> getAllCompanyInfos() {
        ...
        try {
            ...
            return ResponseEntity.ok(ApiResponse.success("모든 회사 정보를 성공적으로 조회했습니다.", companyInfos));
        } catch (Exception e) {
            log.error("Error fetching all company infos: {}", e.getMessage());
            return ResponseEntity.internalServerError()
                    .body(ApiResponse.failure("회사 정보 조회 중 오류가 발생했습니다."));
        }
    }
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<ApiResponse<CompanyInfoDto>> getCompanyInfoById(@PathVariable Long id) {
        ...
        try {
            ...
            return ResponseEntity.ok(ApiResponse.success("회사 정보를 성공적으로 조회했습니다.", companyInfo));
        } catch (RuntimeException e) {
            log.error("Company info not found with ID: {}", id);
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(ApiResponse.failure("해당 ID의 회사 정보를 찾을 수 없습니다."));
        } catch (Exception e) {
    ...
    public ResponseEntity<ApiResponse<CompanyInfoDto>> getCompanyInfoByBusinessNumber(@PathVariable String businessRegistrationNumber) {
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(ApiResponse.failure("해당 사업자등록번호의 회사 정보를 찾을 수 없습니다."));
        } catch (Exception e) {
     ...
     */
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<CompanyInfoDto>> partialUpdateCompanyInfo(@PathVariable Long id, @RequestBody CompanyInfoDto partialUpdateDto) {
        ...
        try {
            ...
            return ResponseEntity.ok(ApiResponse.success("회사 정보가 성공적으로 부분 수정되었습니다.", updatedCompanyInfo));
        } catch (IllegalArgumentException e) {
            ...
            return ResponseEntity.internalServerError()
                    .body(ApiResponse.failure("회사 정보 부분 수정 중 오류가 발생했습니다."));
        }
    }
